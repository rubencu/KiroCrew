...
def test_live_slot_titles_excludes_self_and_unfiled() -> None:
    slots = {
        "me": SimpleNamespace(key="me", folder_id="a", title="Mine"),
        "sib": SimpleNamespace(key="sib", folder_id="a", title="Sibling"),
        "loose": SimpleNamespace(key="loose", folder_id="", title="Loose"),
    }
